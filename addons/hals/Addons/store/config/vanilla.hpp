		...
		class sniperRiflesVanilla 
		{
			...
			ITEM(srifle_LRR_F, 4000, RIFLE_STOCK);
			ITEM(srifle_LRR_camo_F, 4000, RIFLE_STOCK);

			ITEM(srifle_GM6_F, 4500, RIFLE_STOCK);
			ITEM(srifle_GM6_camo_F, 4500, RIFLE_STOCK);
		...
		class launchersVanilla 
		{
			...
			ITEM(launch_B_Titan_F, 3500, LAUNCHER_STOCK);
			ITEM(launch_I_Titan_F, 3500, LAUNCHER_STOCK);
			ITEM(launch_O_Titan_F, 3500, LAUNCHER_STOCK);

			ITEM(launch_B_Titan_short_F, 3250, LAUNCHER_STOCK);
			ITEM(launch_I_Titan_short_F, 3250, LAUNCHER_STOCK);
			ITEM(launch_O_Titan_short_F, 3250, LAUNCHER_STOCK);
